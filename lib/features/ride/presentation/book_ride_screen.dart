  ...
  class _BookRideScreenState extends ConsumerState<BookRideScreen>
    ...
    switch (request) {
      case TripRequestWrapper():        // or whatever the first case is
        Navigator.of(context, rootNavigator: true).pushNamed(AppRoutes.rideTracking,
            arguments: {'rideId': request.id});
      case DeliveryRequestWrapper():
        Navigator.of(context, rootNavigator: true).pushNamed(AppRoutes.deliveryTracking,
            arguments: {'deliveryId': request.id});
      case GasRefillRequestWrapper():
        Navigator.of(context, rootNavigator: true).pushNamed(AppRoutes.gasTracking,
